...
// HTML/CSS/JS Bundle for zero-dependency operation
...
<head>
    ...
    <title>HiFi Audio & Production Personal Wiki</title>
    <!-- Fonts -->
...
<body>
    ...
    <main>
        <div class="content-container">
            <article class="wiki-content" id="wikiContent">
                <!-- Welcome/Home Page -->
                <h1>🎧 HiFi Audio & Production Personal Wiki</h1>
                <p>FiiO M21 디지털 오디오 플레이어(DAP)를 허브 삼아, 다양한 고음질 기기 용어, 스트리밍 환경, 필드 레코딩 및 시퀀서 활용법 등을 체계적으로 기록한 개인 지식 사전입니다.</p>
    ...
    <script>
        ...
        // Initialize App: Load Tree navigation and Search Index
        ...
        // Fetch and Render Markdown Page Content
        function loadPage(pagePath) {
            ...
            fetch('/api/page?path=' + encodeURIComponent(pagePath))
                .then(function(res) {
                ...
                .catch(function(err) {
                    console.error(err);
                    document.getElementById('wikiContent').innerHTML = '<h1>⚠️ 페이지 로딩 에러</h1><p>해당 마크다운 파일을 읽을 수 없습니다.</p>';
                });
        }
    </script>
</body>
